...
//            mTintView.setVisibility(GONE);
    ...
    private void dispatchCallBack(String item) {
        for (SuggestionsListCallBack callBack : callBacks) {
...
//        });
    ...
    private void setVisibleWithAnimation() {
        AnimationUtil.AnimationListener animationListener = new AnimationUtil.AnimationListener() {
            ...
            public boolean onAnimationStart(View view) {
                if (mSearchViewListener != null) {
                    mSearchViewListener.onSearchViewAnimationStart();
                }
                return false;
            }
    ...
    public interface SearchViewListener {
        ...
        void onSearchViewAnimationStart();
    }

    private ArrayList<SuggestionsListCallBack> callBacks = new ArrayList<>();

    public void addCallBack(SuggestionsListCallBack callBack) {
