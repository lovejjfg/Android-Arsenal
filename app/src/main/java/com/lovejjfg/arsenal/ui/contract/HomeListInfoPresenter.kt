...
class HomeListInfoPresenter(view: ListInfoContract.View) : BaseListInfoPresenter(view) {
    ...
    override fun onRefresh() {
        ...
        val subscription =
            DataManager.handleNormalService<ArsenalListInfo>(
                DataManager.getArsenalApi().arsenalListInfo,
                Action1 { info ->
    ...
    override fun onLoadMore() {
        ...
        unSubscribe()
        val subscription =
            DataManager.handleNormalService<ArsenalListInfo>(DataManager.getArsenalApi().loadMoreArsenalListInfo(
                mHasMore
            ), { info ->
                mHasMore = info.hasMore
